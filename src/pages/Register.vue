<template>
     <div class="w-full flex flex-wrap">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" onsubmit="event.preventDefault();">
                    <div class="flex flex-col pt-4">
                        ...
                        <input v-model="user.name" type="text" id="name" placeholder="John Smith" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    ...
                    <div class="flex flex-col pt-4">
                        ...
                        <input v-model="confirm_password" type="password" id="confirm-password" placeholder="Password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                ...
                <div class="text-center pt-12 pb-12">
                    <p>Already have an account? <g-link to="/login" class="underline font-semibold">Log in here</g-link></p>
                </div>
            </div>
        ...
        <div class="w-1/2 shadow-2xl">
            <g-image class="object-cover w-full h-screen hidden md:block" src="../assets/img/photo-1555679427-1f6dfcce943b.jpg"/>
        </div>
    </div>
</template>
<script>
